...
$header .= "From: Новая заявка <trusowa.viky@gmail.com>\n\n";
$mail = mail("trusowa.viky@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
